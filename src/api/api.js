...
const getMovieDetails = async id => await axios.get(`${URL}/movie/${id}?api_key=${TOKEN}&${LANG}&append_to_response=credits,release_dates`);

const getSimilarMovies = async (id, page) => await axios.get(`${URL}/movie/${id}/similar?api_key=${TOKEN}&${LANG}&page=${page}`);
